		...
		<div class="tab-content">
            ...
            <div class="tab-pane box active" id="list">
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                    ...
                    <tbody>
					<?php 				
								$query=mysqli_query($con,"select * from exam where category_id='".$_POST['c_id']."' and subcategory_id='".$_POST['s_c_id']."'  and subject_id='".$_POST['s_id']."' and exam_status=1");
								$i=0;
								...
								?>
									...
									{
										 $query1 = "select * from practice_exam_status where subject_id='".$_POST['s_id']."' and center_id='".$_SESSION['center_id']."' and exam_id='".$row['e_id']."' and student_id='".$_SESSION['student_id']."'";
										...
										{
										?>
										<form name="take_exam_<?php echo $row['e_id'];?>" method="POST" action="termscondition.php">
										<input type="hidden" name="exam_id" value="<?php echo $row['e_id'];?>">								
									...
									{
										$query1 = "select max(exam_date) from practice_exam_status where subject_id='".$_POST['s_id']."' and center_id='".$_SESSION['center_id']."' and exam_id='".$row['e_id']."' and student_id='".$_SESSION['student_id']."'";
