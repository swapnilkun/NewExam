...
if (isset($_POST['submit'])) 
   {
		...
		{
			$query = "SELECT * from student WHERE password ='".$_POST['old_pass']."' AND student_id='".$student_id."' ";
			...
			confirm_query($result_set);
				...
				if (mysqli_num_rows($result_set) == 1) 
					{
						$query = "UPDATE student SET password='{$_POST['new_pass']}', password_md5 ='".encrypt($_POST['new_pass'])."' WHERE student_id ='".$student_id."' ";
            ...
            <div class="row-fluid">
                <div class="area-top clearfix">
                    <div class="pull-left header">
                        <h3 class="title">
                        <i class="icon-edit"></i>
                         <?php echo constant('TI_CHANGE');?>&nbsp;<?php echo constant('TI_PASSWORD');?> </h3>
                    </div>
		...
		<ul class="nav nav-tabs nav-tabs-left">
			...
			<li class="active">
            	<a href="#list" data-toggle="tab"><i class="icon-lock"></i> 
					<?php echo constant('TI_CHANGE');?>&nbsp;<?php echo constant('TI_PASSWORD');?>	</a></li>
		</ul>
