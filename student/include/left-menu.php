...
<?php if(basename(url())=="selectexam.php"){ ?>
			<li class="dark-nav active"><?php }else { ?><li class="dark-nav"><?php } ?>
			<span class="glow"></span>
				<a href="selectexam.php" rel="tooltip" data-placement="right" 
  ...
  <?php if(basename(url())=="practice_history.php"){ ?>
			<li class="dark-nav active"><?php }else { ?><li class="dark-nav"><?php } ?>
			<span class="glow"></span>
				<a href="practice_history.php" rel="tooltip" data-placement="right" 
	...
	<?php if(basename(url())=="selectmainexam.php"){ ?>
			<li class="dark-nav active"><?php }else { ?><li class="dark-nav"><?php } ?>
			<span class="glow"></span>
				<a href="selectmainexam.php" rel="tooltip" data-placement="right" 
		...
		<?php if(basename(url())=="maintest_history.php"){ ?>
			<li class="dark-nav active"><?php }else { ?><li class="dark-nav"><?php } ?>
			<span class="glow"></span>
				<a href="maintest_history.php" rel="tooltip" data-placement="right" 
	...
	<?php if(basename(url())=="hall_ticket.php"){ ?>
			<li class="dark-nav active"><?php }else { ?><li class="dark-nav"><?php } ?>
			<span class="glow"></span>
