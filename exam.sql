...
--
-- Host: 127.0.0.1
-- Generation Time: May 11, 2018 at 12:35 PM
...
INSERT INTO `city` (`id`, `student_city`) VALUES
(1, 'Pune'),
(2, 'kolhapur');
...
(0, 119, 'ssddf', 'single', 'aa', 'bb', 'cc', 'dd', 'A'),
(0, 120, 'ssddf', 'single', 'aa', 'bb', 'cc', 'dd', 'A'),
(118, 121, 'ertyuio', 'single', 'a', 'b', 'c', 'd', 'b'),
(119, 122, 'cvbnm,', 'single', 'A', 'B', 'C', 'D', 'A'),
(118, 123, 'ertyuio', 'single', 'a', 'b', 'c', 'd', 'b'),
(119, 124, 'cvbnm,', 'single', 'A', 'B', 'C', 'D', 'A');
...
(126, 30, 67, 49, 1, 5, 'objective'),
(127, 30, 67, 49, 1, 5, 'objective'),
(128, 52, 67, 49, 1, 20, 'objective'),
(129, 52, 67, 49, 1, 10, 'objective'),
(130, 52, 67, 49, 1, 20, 'objective'),
(131, 52, 67, 49, 1, 10, 'objective');
...
CREATE TABLE `states` (
  `id` int(100) NOT NULL,
  `states_name` varchar(1000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(38, 67, 49, 30, 0, 1, 'Rushi', 'Sharad', 'Sunita', '08/12/1993', 'Pune', '9870908700', 'rushi@demo.com', 'rushi', '12345', '37oDJrYtFAg=', 1, ''),
(39, 67, 49, 30, 0, 1, 'Rushi', 'Sharad', 'Sunita', '08/12/1993', 'Pune', '9870908700', 'rushi@demo.com', 'rushi', '12345', '37oDJrYtFAg=', 1, '');
...
--
ALTER TABLE `objective_table`
  MODIFY `o_q_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
--
...
--
ALTER TABLE `subcategory`
  MODIFY `s_c_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
--
