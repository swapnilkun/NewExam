...
{
	$query1 = "select * from main_exam_status where subject_id='".$row['subject_id']."' and center_id='".$_SESSION['center_id']."' and exam_id='".$e_id."' and student_id='".$_SESSION['student_id']."'";
	...
	else
	{
		...
		$query1 = "select max(exam_date) from main_exam_status where center_id='".$center_id."' and exam_id='".$e_id."' and student_id='".$_SESSION['student_id']."'";
		...
		$query_noofattemps = "select max(noofattemps) from main_exam_status where center_id='".$center_id."' and exam_id='".$e_id."' and student_id='".$_SESSION['student_id']."'";
		...
		if($days >= $re_exam_day)
		{
			...
			$query_question=mysqli_query($con,"select * from question where e_id='".$e_id."' and question_status=1"); 
			...
			$query=mysqli_query($con,"insert into main_exam_status (category_id,subcategory_id,subject_id,exam_id,exam_date,status,student_id,center_id,noofattemps) values('".$category_id."','".$subcategory_id."','".$subject_id."','".$e_id."',now(),1,'".$_SESSION['student_id']."','".$center_id."','".$noofattemps."')");
			...
			for($i=0;$i<$count; $i++)
			{
				...
				{
					$qid=$q_id[$i];
					$query_question_typeofquestion=mysqli_fetch_array(mysqli_query($con,"select * from question where e_id='".$e_id."' and q_id='".$q_id[$i]."'  and question_status=1")); 
					if($query_question_typeofquestion['typeofquestion']=='Single')
					{
						...
						if($_POST[$radio]!="")
						{
							...
							$query=mysqli_query($con,"insert into main_answer (category_id,subcategory_id,subject_id,exam_id,question_id,ans,marks,	examdate,correct_ans,typeofquestion,student_id,center_id,question,option_a,option_b,option_c,option_d,main_exam_status_id)values('".$category_id."','".$subcategory_id."','".$subject_id."','".$e_id."','".$qid."',	'".$_POST[$radio]."','".$marks[$i]."',now(),'".$correct_ans[$i]."','Single','".$_SESSION['student_id']."','".$center_id."','".$query_question_typeofquestion['question']."','".$query_question_typeofquestion['option_a']."','".$query_question_typeofquestion['option_b']."','".$query_question_typeofquestion['option_c']."','".$query_question_typeofquestion['option_d']."','".$last_insert_id."')");

						}
						else
						{
					
							$query=mysqli_query($con,"insert into main_answer (category_id,subcategory_id,subject_id,exam_id,question_id,ans,marks,	examdate,correct_ans,typeofquestion,student_id,center_id,question,option_a,option_b,option_c,option_d,main_exam_status_id)values('".$category_id."','".$subcategory_id."','".$subject_id."','".$e_id."','".$qid."',	'Not Answer','".$marks[$i]."',now(),'".$correct_ans[$i]."','Single','".$_SESSION['student_id']."','".$center_id."','".$query_question_typeofquestion['question']."','".$query_question_typeofquestion['option_a']."','".$query_question_typeofquestion['option_b']."','".$query_question_typeofquestion['option_c']."','".$query_question_typeofquestion['option_d']."','".$last_insert_id."')");
					...
					{			
						...
						if($_POST[$checkbox_A]!="" || $_POST[$checkbox_B]!="" || $_POST[$checkbox_C]!="" || $_POST[$checkbox_D]!="")
						{
							...
							$query=mysqli_query($con,"insert into main_answer (category_id,subcategory_id,subject_id,exam_id,question_id,ans,marks,	examdate,correct_ans,typeofquestion,student_id,center_id,question,option_a,option_b,option_c,option_d,main_exam_status_id)values('".$category_id."','".$subcategory_id."','".$subject_id."','".$e_id."','".$qid."',	'".$checkbox."','".$marks[$i]."',now(),'".$correct_ans[$i]."','Multiple','".$_SESSION['student_id']."','".$center_id."','".$query_question_typeofquestion['question']."','".$query_question_typeofquestion['option_a']."','".$query_question_typeofquestion['option_b']."','".$query_question_typeofquestion['option_c']."','".$query_question_typeofquestion['option_d']."','".$last_insert_id."')");
						}
						else
						{								
							$query=mysqli_query($con,"insert into main_answer (category_id,subcategory_id,subject_id,exam_id,question_id,ans,marks,	examdate,correct_ans,typeofquestion,student_id,center_id,question,option_a,option_b,option_c,option_d,main_exam_status_id)values('".$category_id."','".$subcategory_id."','".$subject_id."','".$e_id."','".$qid."',	'Not Answer','".$marks[$i]."',now(),'".$correct_ans[$i]."','Multiple','".$_SESSION['student_id']."','".$center_id."','".$query_question_typeofquestion['question']."','".$query_question_typeofquestion['option_a']."','".$query_question_typeofquestion['option_b']."','".$query_question_typeofquestion['option_c']."','".$query_question_typeofquestion['option_d']."','".$last_insert_id."')");
						}
					}					
				}
			}
...
$query_exam_take_status=mysqli_fetch_array(mysqli_query($con,"select * from main_exam_status where exam_id='".$e_id."' and category_id='".$exam_name['category_id']."' and subcategory_id='".$exam_name['subcategory_id']."' and subject_id='".$exam_name['subject_id']."' and center_id='".$center_id."' and student_id='".$_SESSION['student_id']."' and exam_date='".$given_exam_date."'"));



$query_answer=mysqli_query($con,"select * from main_answer where student_id='".$_SESSION['student_id']."' and exam_id='".$e_id."' and center_id='".$center_id."' and category_id='".$exam_name['category_id']."' and subcategory_id='".$exam_name['subcategory_id']."' and 	subject_id='".$exam_name['subject_id']."' and examdate='".$given_exam_date."' and main_exam_status_id='".$query_exam_take_status['id']."'");
...
$query_status_count=mysqli_query($con,"select * from main_answer where student_id='".$_SESSION['student_id']."' and exam_id='".$e_id."' and center_id='".$center_id."' and category_id='".$exam_name['category_id']."' and subcategory_id='".$exam_name['subcategory_id']."' and 	subject_id='".$exam_name['subject_id']."' and examdate='".$given_exam_date."' and main_exam_status_id='".$query_exam_take_status['id']."'");
...
$query_answer_table=mysqli_query($con,"select * from main_answer where student_id='".$_SESSION['student_id']."' and exam_id='".$e_id."' and center_id='".$center_id."' and category_id='".$exam_name['category_id']."' and subcategory_id='".$exam_name['subcategory_id']."' and 	subject_id='".$exam_name['subject_id']."' and examdate='".$given_exam_date."' and main_exam_status_id='".$query_exam_take_status['id']."'");
	$i=1;
...
$email.="<table border='0' cellpadding='0' cellspacing='0' width='100%'>";
	...
	$email.="</tr>";
	$email.="<tr>";
	$email.="<td style='border-bottom:1px solid #ccc;line-height:30px;font-size:16px;padding-left:5px'>Center Name:</td>";
	$email.="<td style='border-bottom:1px solid #ccc;border-left:1px solid #ccc;line-height:30px;font-size:16px;padding-left:5px'>".$query_center_name['centername']."</td>";
	$email.="</tr>";
	$email.="<tr>";
