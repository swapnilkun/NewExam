                    ...
                    <div class="padded" style="margin-top:10px">
                        ...
                        <div class="login box" style="margin-top: 10px;">
                            ...
                            <div class="box-content padded">                            
                                <form action="index.php" method="post" accept-charset="utf-8" class="separate-sections">
                                    <div style="display:none"><input type="hidden" name="login_type" value="center" /></div>
									<center>
