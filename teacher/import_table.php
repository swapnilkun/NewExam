	...
	if($_FILES['g_logo']['name']!="")
	{
		...
		if(in_array($extension_type , array('xls')))
		{
			if($extension_type=='xls')
			{
					...
					if($fileupload)
					{
						$message_success .=  "File is uploaded successfully.";
					}
					else
					{
				...
				<?php include("message.php");?>
					<div class="box-header">    
						<ul class="nav nav-tabs nav-tabs-left">
							<li class="active">
								<a href="#list" data-toggle="tab"><i class="icon-align-justify"></i><?php echo "Import List";?></a>
							</li>
							<li>
								<a href="#add" data-toggle="tab"><i class="icon-plus"></i><?php echo "Add File";?></a>
								...
								<table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
									<thead>
										<tr>
											...
											<th><div><?php echo "File Name";?></div></th>  
                	...
                	<form action="<?php $PHP_SELF ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8" class="form-horizontal validatable" target="_top">	
						<div class="padded">       
							<div class="control-group">
                                <label class="control-label"><?php echo "Upload File";?></label>
                                <div class="controls">
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-gray"><?php echo "Upload File";?></button>
...
<div id="modal-delete" class="modal hide fade" style="height:140px;">
   ...
   <div class="modal-delete-body" id="modal-body-delete"><?php echo "Are you sure, you want to delete this file ?";?></div>
    <div class="modal-footer">
