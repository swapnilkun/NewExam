...
if(isset($_POST['submit']) && $_POST['student_id']!="" && $_POST['center_id']!="")
{	
	...
	$b_id= $_POST['b_id'];
		 ...
		 $query_update_mysql_student=mysqli_query($con,"update student set category_id='{$category_id}', b_id='{$b_id}',student_name='{$student_name}', student_father='{$student_father}',student_mother='{$student_mother}',student_address='{$student_address}',student_phone='{$student_phone}',password='{$password}',password_md5='{$password_md5}' where student_id='".$_POST['student_id']."' and center_id='".$_POST['center_id']."'");
				...
				<form method="post" action="" class="form-horizontal validatable" enctype="multipart/form-data">
						...
						<div class="padded">                   
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="validate[required]" name="student_name" value="<?php echo $result['student_name']; ?>" />
                                </div>
                            </div>
                        </div>
						...
						<div class="padded">                   
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="validate[required]" name="student_father" value="<?php echo $result['student_father']; ?>" />
                                </div>
                            </div>
                        </div>
						<div class="padded">                   
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="student_mother" class="validate[required]" value="<?php echo $result['student_mother']; ?>" />
                                </div>
                            </div>
                        </div>
