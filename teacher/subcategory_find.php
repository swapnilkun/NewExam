...
$query=mysqli_query($con,"SELECT * FROM subcategory s JOIN teacher t ON s.s_c_id=t.subcategory_id WHERE t.center_id='".$_SESSION['center_id']."' and subcategory_status=1");
