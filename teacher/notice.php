...
{ 
	...
	$query_insert_notice = "INSERT INTO notice (noitce,notice_subject,notice_date,status,center_id) VALUES('{$notice_textarea}','{$notice_subject}','{$notice_date_from}',1,'{$_SESSION['center_id']}')";
	$result_notice=mysqli_query($con,$query_insert_notice);
	if($result_notice)
	{
		$message_success .= constant('TI_NOTICE_ADD_SUCCESS_MESSAGE');
	}
	else
	{
            ...
            <div class="row-fluid">
                <div class="area-top clearfix">
                    <div class="pull-left header">
                        <h3 class="title">
                        <i class="icon-edit"></i>
                        <?php echo constant('TI_MANAGE_NOTICE');?> </h3>
                    </div>
		...
		<ul class="nav nav-tabs nav-tabs-left">
			...
			<li>
            	<a href="#add" data-toggle="tab"><i class="icon-plus"></i>
					     <?php echo constant('TI_LABEL_ADD_NOTICE');?></a></li>
		</ul>
            ...
            <div class="tab-pane box active" id="list">
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                	<thead>
                		<tr>
                    		<th><div>#</div></th>
							<th><div><?php echo constant('TI_LABEL_NOTICE_SUBJECT');?></div></th>  
                    		<th><div><?php echo constant('TI_LABEL_NOTICE');?></div></th>   
							<th><div><?php echo constant('TI_LABEL_NOTICE_STATUS');?></div></th> 
                    		<th><div><?php echo constant('TI_TABLE_OPTIONS');?></div></th>
						</tr>
					</thead>
                    <tbody>
							<?php 
								$query=mysqli_query($con,"select * from notice where center_id='".$_SESSION['center_id']."' order by notice_date");
								$i=0;
							...
							?>
								...
								<td align="center">
								<a data-toggle="modal" href="edit_notice.php?n_id=<?php echo $row['n_id'];?>" class="btn btn-gray btn-small"><i class="icon-wrench"></i> <?php echo constant('TI_EDIT');?></a>
								...
								<a data-toggle="modal" href="noticestudent.php?n_id=<?php echo $row['n_id'];?>" class="btn btn-danger btn-small"><i class="icon-user"></i> <?php echo 'student';?></a>
                ...
                <div class="box-content">
					...
					<div style="display:none">
                                ...
                                <div class="controls">
                                     <div class="box closable-chat-box">
                                        <div class="box-content">
                                                ...
                                                <textarea name="notice_textarea" id="ttt" class="validate[required]" rows="5" placeholder="add notice"></textarea>
                                                </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-gray"><?php echo "Add Notice";?></button>
