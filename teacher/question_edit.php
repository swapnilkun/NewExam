...
include('include/left-menu.php');
		...
		if (isset($_POST['submit']) and $_POST['p_e_id']!="" and $_POST['p_q_id']!="") 
		{ 			
			...
			if($typeofquestion=="Single")
			{
				...
				$query_question_insert = "update practice_question set p_e_id='".$_POST['p_e_id']."',c_id='".$category_id."',s_c_id='".$s_c_id."',question='".$question."',typeofquestion='".$typeofquestion."',option_a='".$option_a."',option_b='".$option_b."',option_c='".$option_c."',option_d='".$option_d."',correct_ans='".$correct_ans."',marks='".$marks."' where p_q_id='".$_POST['p_q_id']."' and p_e_id='".$_POST['p_e_id']."'";			
...
if($_GET['p_e_id']!="" and $_GET['p_q_id']!="")
{
	$p_e_id= $_GET['p_e_id'];
	$p_q_id= $_GET['p_q_id'];

	$query=mysqli_query($con,"select * from practice_question where p_q_id='".$p_q_id."' and p_e_id='".$p_e_id."'");
		...
		<div class="tab-content">        
			   ...
			   <div class="padded">                   
				...
				<div class="form-actions">
					...
					<input type="hidden" value="<?php echo $_GET['p_e_id'];?>" name="p_e_id">
					<input type="hidden" value="<?php echo $_GET['p_q_id'];?>" name="p_q_id">
