...
include('include/left-menu.php');
		...
		{ 		
			...
			$subject_query=mysqli_query($con,"select * from subject where s_id='".$_POST['s_id']."' and center_id='".$_SESSION['center_id']."' ");
				...
				<div class="padded">       
							<div class="control-group">
                                ...
                                <div class="controls">
									...
									<option value=""><?php echo constant('TI_DROPDOWN_SUBJECT');?></option>  
										<?php $query_subject=mysqli_query($con,"select * from subject where center_id='".$_SESSION['center_id']."'");
