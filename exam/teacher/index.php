...
if($_POST['login_type']=='center')
{
		...
		else
		{
			...
			$query="SELECT * FROM teacher WHERE email='{$email}' AND password_md5='{$password}' AND teacher_status=1";
			...
			if (mysqli_num_rows($result_set) == 1) 
			{
				...
				$_SESSION['teacher_name'] = $found_user['teacher_name'];
...
<html>
	<head>
		...
		<link href="css/center.css" media="screen" rel="stylesheet" type="text/css" />
		<!--[if lt IE 9]>
            ...
            <div class="container">
                <div class="span4 offset4">
                    <div class="padded" style="margin-top:10px">
						...
						<center>						
							<img src="../images/panel/teacher.png"> 											
                        </center> 
