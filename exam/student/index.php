...
if($_POST['login_type']=='center')
{
		...
		else
		{
			...
			$query="SELECT * FROM student WHERE student_email='{$email}' AND password_md5='{$password}' AND student_status=1";
			$result_set = mysqli_query($con,$query);
			confirm_query($result_set);
			if (mysqli_num_rows($result_set) == 1) 
			{
				$found_user = mysqli_fetch_array($result_set);			
				$_SESSION['student_id'] = $found_user['student_id'];
				$_SESSION['center_id'] = $found_user['center_id'];
				$_SESSION['student_email'] = $found_user['student_email'];
				$_SESSION['student_name'] = $found_user['student_name'];
...
<html>
	<head>
		...
		<link rel="stylesheet" href="css/centerfont.css">
		<link href="css/jquery/jquery-ui-1.10.3.custom.css" media="screen" rel="stylesheet" type="text/css" />
		<link href="css/student.css" media="screen" rel="stylesheet" type="text/css" />
		<!--[if lt IE 9]>
                        ...
                        <a class="brand" href="#"><?php echo $query_general_setting['g_organization'];?></a>   
						 <ul class="nav pull-right">
                            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo constant("TI_LOGIN_HEADER_SELECT_SECTION");?><b class="caret"></b></a>
                                ...
                                <li><a href="index.php"><?php echo constant("TI_LOGIN_HEADER_STUDENT");?></a></li> 
								<li><a href="../teacher/index.php"><?php echo "Teacher";?></a></li>  								
								<li><a href="../admin/index.php"><?php echo constant("TI_LOGIN_HEADER_ADMIN");?></a></li>  
                                </ul>
            ...
            <div class="container">
                <div class="span4 offset4">
                    <div class="padded" style="margin-top:10px">
						...
						<center>						
							<img src="../images/panel/student.png"> 											
                        </center> 
                        ...
                        <div class="login box" style="margin-top: 10px;">
                            ...
                            <div class="box-content padded">                            
                                <form action="index.php" method="post" accept-charset="utf-8" class="separate-sections"><div style="display:none"><input type="hidden" name="login_type" value="center" /></div>
									<center>
