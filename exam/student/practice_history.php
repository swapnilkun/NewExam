            ...
            <div class="tab-pane box active" id="list">
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                    ...
                    <tbody>
							...
							$query=mysqli_query($con,"select * from practice_exam_status where student_id='".$_SESSION['student_id']."' and status=1" );
								$i=0;
							...
							?>
								...
								<td align="center">
								<a data-toggle="modal" target="_new" href="history-result.php?exam_id=<?php echo encrypt_string($row['exam_id']);?>&exam_dy=<?php echo encrypt_string($row['exam_date']);?>" class="btn btn-gray btn-small"><i class="icon-wrench"></i> View Result</a>
