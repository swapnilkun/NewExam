...
if($row['re_exam_day']==0)
{
	...
	else
	{
		...
		$result_noofattemps = mysqli_query($con,$query_noofattemps) or die ("Error in query: $query. " .mysql_error($con));
		...
		if($days >= $re_exam_day)
		{
			...
			$query_question=mysqli_query($con,"select q.q_id,o.correct_ans,q.marks from questions_table q join objective_table o on q.q_id= o.q_id where q.s_id='".$subject_id."' and q.question_status=1"); 
			...
			for($i=0;$i<$count; $i++)
			{
				if($q_id[$i]!="")
				{
					...
					$query_question_typeofquestion=mysqli_fetch_array(mysqli_query($con,"select o.typeofquestion,o.option_a,o.option_b,o.option_c,o.option_d,o.question from questions_table q join objective_table o on q.q_id=o.q_id where q.q_id='".$q_id[$i]."' and q.s_id='".$subject_id."'  and q.question_status=1")); 
					if($query_question_typeofquestion['typeofquestion']=='Single')
					{
						...
						if($_POST[$radio]!="")
						{
							...
							$query=mysqli_query($con,"insert into practice_answer (category_id,subcategory_id,subject_id,exam_id,question_id,ans,marks,	examdate,correct_ans,typeofquestion,student_id,center_id,question,option_a,option_b,option_c,option_d,practice_exam_status_id)values('".$category_id."','".$subcategory_id."','".$subject_id."','".$e_id."','".$qid."',	'".$_POST[$radio]."','".$marks[$i]."',now(),'".$correct_ans[$i]."','Single','".$_SESSION['student_id']."','".$center_id."','".mysqli_real_escape_string($con,$query_question_typeofquestion['question'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_a'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_b'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_c'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_d'])."','".$last_insert_id."')");

						}
						else
						{
					
							$query=mysqli_query($con,"insert into practice_answer (category_id,subcategory_id,subject_id,exam_id,question_id,ans,marks,	examdate,correct_ans,typeofquestion,student_id,center_id,question,option_a,option_b,option_c,option_d,practice_exam_status_id)values('".$category_id."','".$subcategory_id."','".$subject_id."','".$e_id."','".$qid."',	'Not Answer','".$marks[$i]."',now(),'".$correct_ans[$i]."','Single','".$_SESSION['student_id']."','".$center_id."','".mysqli_real_escape_string($con,$query_question_typeofquestion['question'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_a'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_b'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_c'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_d'])."','".$last_insert_id."')");
					...
					{			
						...
						if($_POST[$checkbox_A]!="" || $_POST[$checkbox_B]!="" || $_POST[$checkbox_C]!="" || $_POST[$checkbox_D]!="")
						{
							...
							$query=mysqli_query($con,"insert into practice_answer (category_id,subcategory_id,subject_id,exam_id,question_id,ans,marks,	examdate,correct_ans,typeofquestion,student_id,center_id,question,option_a,option_b,option_c,option_d,practice_exam_status_id)values('".$category_id."','".$subcategory_id."','".$subject_id."','".$e_id."','".$qid."',	'".$checkbox."','".$marks[$i]."',now(),'".$correct_ans[$i]."','Multiple','".$_SESSION['student_id']."','".$center_id."','".mysqli_real_escape_string($con,$query_question_typeofquestion['question'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_a'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_b'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_c'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_d'])."','".$last_insert_id."')");
						}
						else
						{								
							$query=mysqli_query($con,"insert into practice_answer (category_id,subcategory_id,subject_id,exam_id,question_id,ans,marks,	examdate,correct_ans,typeofquestion,student_id,center_id,question,option_a,option_b,option_c,option_d,practice_exam_status_id)values('".$category_id."','".$subcategory_id."','".$subject_id."','".$e_id."','".$qid."',	'Not Answer','".$marks[$i]."',now(),'".$correct_ans[$i]."','Multiple','".$_SESSION['student_id']."','".$center_id."','".mysqli_real_escape_string($con,$query_question_typeofquestion['question'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_a'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_b'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_c'])."','".mysqli_real_escape_string($con,$query_question_typeofquestion['option_d'])."','".$last_insert_id."')");
						}
					}					
				}
			}
...
else
{
	...
	$message.="<td class='news-title'>".$result_ques_marks['center_id']."</td>";
	$message.="</tr>"; */
	$message.="<tr>";
