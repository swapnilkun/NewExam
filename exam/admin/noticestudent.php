...
{ 
	  if($_POST['cbg1']!="")
	 {
			...
			for ($i=0; $i<sizeof($checkBox); $i++)
			{
				...
				$query_insert=mysqli_query($con,"insert into noticestudent (student_id,notice_id,admin_id,notice_date) values('".$checkBox[$i]."','".$_REQUEST['n_id']."','".$_SESSION['user_id']."','".$query_date['notice_date']."')"); 
