...
include('include/left-menu.php');
		...
		{ 
			...
			$query_update = "update questions_table set  marks='".$marks."' where q_id='".$_POST['q_id']."' and s_id='".$_POST['s_id']."'";
			...
			if($typeofquestion=="Single")
			{
				...
				$query_question_update = "update objective_table set question='".$question."',typeofquestion='".$typeofquestion."',option_a='".$option_a."',option_b='".$option_b."',option_c='".$option_c."',option_d='".$option_d."',correct_ans='".$correct_ans."' where q_id='".$_POST['q_id']."' and o_q_id='".$_GET['o_q_id']."' ";
			...
			else if($typeofquestion=="Multiple")
			{
				...
				$query_question_update = "update objective_table set question='".$question."',typeofquestion='".$typeofquestion."',option_a='".$option_a."',option_b='".$option_b."',option_c='".$option_c."',option_d='".$option_d."',correct_ans='".$correct_ans."' where q_id='".$_POST['q_id']."' and s_id='".$_POST['s_id']."'and o_q_id='".$_GET['o_q_id']."' ";
			}
			else
			{
...
if($_GET['s_id']!="" and $_GET['q_id']!="")
{
	...
	$query=mysqli_query($con,"select * from questions_table where q_id='".$q_id."' and s_id='".$s_id."'");
			   ...
			   <div class="padded">                   
				...
				<div class="padded">                   
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="validate[required,custom[integer]]" name="marks" maxlength="2" value="<?php echo $row['marks'];?>"/>
						</div>
					</div>
				</div>		
