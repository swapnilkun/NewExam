									...
									<tbody>
											<tr class="text-center">
												...
												<td  align="center">								
														...
														<a data-toggle="modal" href="#modal-status-deactive" onclick="modal_status_deactive('subject_status.php?s_id=60')" class="btn btn-red btn-small"><i class="icon-eye-close"></i> </a>
																					
												</td>
												<td align="center">
													<a data-toggle="modal" href="subject_edit.php?s_id=60" class="btn btn-gray btn-small"><i class="icon-pencil"></i> </a>

													<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('subject_delete.php?s_id=60')" class="btn btn-red btn-small"><i class="icon-trash"></i> </a>

													<a data-toggle="modal" href="question_add.php?s_id=60"  class="btn btn-green btn-small"><i class="icon-plus-sign"></i>  </a>

													<a data-toggle="modal" href="viewquestion.php?s_id=60"  class="btn btn-blue btn-small"><i class="icon-zoom-in"></i>  </a>
												</td>
											</tr>
																						<tr class="text-center">
												<td>2</td>
												...
												<td  align="center">								
														...
														<a data-toggle="modal" href="#modal-status-deactive" onclick="modal_status_deactive('subject_status.php?s_id=59')" class="btn btn-red btn-small"><i class="icon-eye-close"></i> </a>
																					
												</td>
												<td align="center">
													<a data-toggle="modal" href="subject_edit.php?s_id=59" class="btn btn-gray btn-small"><i class="icon-pencil"></i> </a>

													<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('subject_delete.php?s_id=59')" class="btn btn-red btn-small"><i class="icon-trash"></i> </a>

													<a data-toggle="modal" href="question_add.php?s_id=59"  class="btn btn-green btn-small"><i class="icon-plus-sign"></i>  </a>

													<a data-toggle="modal" href="viewquestion.php?s_id=59"  class="btn btn-blue btn-small"><i class="icon-zoom-in"></i>  </a>
												</td>
											</tr>
																						<tr class="text-center">
												<td>3</td>
												...
												<td  align="center">								
														...
														<a data-toggle="modal" href="#modal-status-deactive" onclick="modal_status_deactive('subject_status.php?s_id=61')" class="btn btn-red btn-small"><i class="icon-eye-close"></i> </a>
																					
												</td>
												<td align="center">
													<a data-toggle="modal" href="subject_edit.php?s_id=61" class="btn btn-gray btn-small"><i class="icon-pencil"></i> </a>

													<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('subject_delete.php?s_id=61')" class="btn btn-red btn-small"><i class="icon-trash"></i> </a>

													<a data-toggle="modal" href="question_add.php?s_id=61"  class="btn btn-green btn-small"><i class="icon-plus-sign"></i>  </a>

													<a data-toggle="modal" href="viewquestion.php?s_id=61"  class="btn btn-blue btn-small"><i class="icon-zoom-in"></i>  </a>
												</td>
											</tr>
																						<tr class="text-center">
												<td>4</td>
												...
												<td  align="center">								
														...
														<a data-toggle="modal" href="#modal-status-deactive" onclick="modal_status_deactive('subject_status.php?s_id=62')" class="btn btn-red btn-small"><i class="icon-eye-close"></i> </a>
																					
												</td>
												<td align="center">
													<a data-toggle="modal" href="subject_edit.php?s_id=62" class="btn btn-gray btn-small"><i class="icon-pencil"></i> </a>

													<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('subject_delete.php?s_id=62')" class="btn btn-red btn-small"><i class="icon-trash"></i> </a>

													<a data-toggle="modal" href="question_add.php?s_id=62"  class="btn btn-green btn-small"><i class="icon-plus-sign"></i>  </a>

													<a data-toggle="modal" href="viewquestion.php?s_id=62"  class="btn btn-blue btn-small"><i class="icon-zoom-in"></i>  </a>
												</td>
											</tr>
