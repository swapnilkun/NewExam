...
if (isset($_POST['submit'])) 
   {
		...
		{
			$query = "SELECT * from user WHERE userpassword ='".$_POST['old_pass']."' AND u_id='".$user_id."' ";
			
			$result_set = mysqli_query($con,$query);
			confirm_query($result_set);
				if (mysqli_num_rows($result_set) == 1) 
					{
						$query = "UPDATE user SET userpassword='{$_POST['new_pass']}', userpassword_md5 ='".encrypt($_POST['new_pass'])."' WHERE u_id='".$user_id."' ";
