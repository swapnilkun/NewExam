		...
		<div class="container-fluid padded">
			<div class="box">
				...
				<div class="box-content padded">
					<div class="tab-content" id="print" style="background-color:#fff;">
					<?php
...
if($_GET['exam_id']!="")
{
	...
	$subcategory_id= $row_check_center['subcategory_id'];
	//echo $subcategory_id;
...
$query_subject=mysqli_fetch_array(mysqli_query($con,"select * from subject where s_id='".$subject_id."'"));
 ...
 $result=mysqli_query($con,"select s.student_name,b.batch_name,b.batch_time,s.student_id from student s join batch b on s.b_id=b.b_id WHERE subcategory_id='".$subcategory_id."' ");

while($row1=mysqli_fetch_assoc($result)){	 
	 ?>
						<div class="tab-pane box active" id="list" valign="top">
							<div class="ticket" style="background-color:#fff;">
								<div class="row" style="margin-top: 18px;">
								   <div class="col-md-2 padding-p-l">
										<img src="../images/logo/your_school.png" style="margin-left:52px" width="110">
								...
								<div class="row">
									<div class="middle">
										<div class="info">
											<p><b>Enrollment No: </b><?php echo $row1['student_id'];?></p>
											<p><b>Student Name: </b> <?php echo $row1['student_name'];?></p>
											...
											<table class="table table-bordered" cellspacing="0" style="margin-bottom:0px;">
												...
												<tbody>
													<tr>
														...
														<td width="15%" style="color: #000 !important;"><?php echo $row1['batch_name'];?></td>
														<td width="15%" style="color: #000 !important;"><?php echo $row1['batch_time'];?></td>
													</tr>
												</tbody>
											</table>
										</div>
