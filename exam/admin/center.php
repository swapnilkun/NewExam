											...
											<tr class="text-center">
											   <td><?php echo $i;?></td>
												...
												<td align="center">
													...
													<a data-toggle="modal" href="center_edit.php?center_id=<?php echo $res['center_id'];?>"  class="btn btn-gray btn-small"><i class="icon-wrench"></i></a>
                ...
                <div class="box-content">
                    ...
                    <td>
                     ...
                     <td>
                    	<div class="padded"> 
							<div class="control-group">
                                <label class="control-label">Branch Manger Address </label>
                                <div class="controls">                                    
                    ...
                    <td>
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-gray">Add Branch Manager</button>
