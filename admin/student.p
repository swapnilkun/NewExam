                  ...
                  <form action="<?php $PHP_SELF ?>" method="post" accept-charset="utf-8" class="form-horizontal validatable" target="_top">
                        ...
                        <div class="padded">                   
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="validate[required]" name="/name" placeholder="Enter last name" />
                                </div>
                            </div>
                        </div>
					    ...
					    <div class="padded">  
                         <label for="interested_course">Course of interest :</label>
				  			<select class="form-control select2" name="interested_course[]" multiple="multiple" data-placeholder="Select a Course">
					          <option value="4798" >CERTIFICATE IN ADVANCED EXCEL ( C1081 )</option><option value="4799" >CERTIFICATE IN DESKTOP PUBLISHING (DTP) ( C1003 )</option>
					          <option value="4800" >CERTIFICATE IN MS OFFICE WITH INTERNET ( C1002 )</option>
					        </select>
					...
					<div class="padded">                   
                            <div class="control-group">
                                ...
                                <div class="controls">
									...
									<textarea name="student_address" class="validate[required]" id="text_for_signature" rows="5" placeholder="Add Address"></textarea>
									</div>
								</div>
                                </div>
                            </div>
                        ...
                        <div class="padded">                   
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="validate[required,custom[integer]] form-control" name="student_phone" placeholder="Alternate Mobile" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="padded">                   
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="validate[required]" name="occupation" value="student" />
                                </div>
                            </div>
                        </div
